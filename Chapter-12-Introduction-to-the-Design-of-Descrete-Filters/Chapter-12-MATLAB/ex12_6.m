%%
% Example 12.6 -- Bilinear transformation and high-pass filtering
%%
clear all; clf
...
figure(2)
subplot(211)
plot(t,x1); grid; xlabel('t'); ylabel('x(t)'); axis([0 0.1 1.1*min(x1) 1.1*max(x1)])
subplot(212)
plot(t,y); grid; xlabel('t'); ylabel('y(t)'); axis([0 0.1 1.1*min(y) 1.1*max(y)])
